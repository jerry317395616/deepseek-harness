...
Source: [`packages/extensions/tool-frappe-docs/src/index.ts:22`](../packages/extensions/tool-frappe-docs/src/index.ts)
...
Source: [`packages/extensions/tool-native-bench-frappe/src/index.ts:23`](../packages/extensions/tool-native-bench-frappe/src/index.ts)
